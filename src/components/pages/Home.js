    ...
    <div id='home' className="w-screen flex md:text-5xl mt-5 md:pt-12 bg-cover md:bg-cover md:bg-fixed bg-no-repeat md:bg-center bg-right max-h-screen md:min-h-screen" style={{
        ...
        <div className='grid sm:grid-cols-5 lg:pl-5 w-screen text-center lg:ml-14 lg:mt-3'>
            <div className='md:text-left md:mt-[100px] text-center sm:ml-12 md:pl-12 md:py-3 sm:flex flex-col md:flex-col md:mx-auto -mt-8'>
                ...
                {/* Original code */}
            {/* <div className='hidden lg:flex text-lg font-semibold w-full mt-5'>
                <button className='border-2 border-solid border-cyan-300 hover:bg-orange-400 px-4 py-3 rounded-lg lg:medium'><a href='https://drive.google.com/file/d/1Xc_-6vw0h1CjI-Qc-7LtzdVrEoFTjtbD/view?usp=sharing'>Download CV</a></button>
                </div> */}
...
//Original Code from the div content
//className='grid sm:grid-cols-5 gap-2 md:pl-5
